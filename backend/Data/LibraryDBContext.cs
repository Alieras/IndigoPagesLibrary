...
public class LibraryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Book>(entity =>
        {
            ...
            entity.Property(book => book.FormatId)
        ...
        modelBuilder.Entity<Format>(entity =>
        {
            ...
            entity.Property(format => format.Id)
                .HasColumnName("id");

            entity.Property(format => format.Name)
                .HasColumnName("name")
                .HasMaxLength(50)
                .IsRequired();

            entity.HasIndex(format => format.Name)
                .IsUnique();

            entity.Property(format => format.Description)
                .HasColumnName("description")
                .HasMaxLength(250);

            entity.Property(format => format.IsActive)
                .HasColumnName("isactive")
                .IsRequired();

            entity.Property(format => format.CreatedAt)
                .HasColumnName("createdat")
                .HasColumnType("timestamp with time zone")
                .IsRequired();

            entity.Property(format => format.UpdatedAt)
                .HasColumnName("updatedat")
                .HasColumnType("timestamp with time zone")
                .IsRequired();
        });
        ...
        modelBuilder.Entity<BookCategory>(entity =>
        {
            ...
            entity.Property(bookCategory => bookCategory.BookId)
                .HasColumnName("bookid");

            entity.Property(bookCategory => bookCategory.CategoryId)
